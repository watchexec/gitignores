...
impl GitIgnore for Global {
	...
	fn list() -> Vec<&'static str> {
		#[allow(unused_mut)]
		let mut list = Vec::with_capacity(72);
		#[cfg(feature = "global-al")]
		list.push("Al");
		#[cfg(feature = "global-anjuta")]
		list.push("Anjuta");
