...
impl GitIgnore for Root {
	...
	fn file_name(self) -> &'static str {
		match self {
			...
			#[cfg(feature = "root-umbraco")]
			Self::Umbraco => "Umbraco.gitignore",
			#[cfg(feature = "root-unity")]
