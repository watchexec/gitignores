...
impl GitIgnore for Root {
	...
	fn list() -> Vec<&'static str> {
		#[allow(unused_mut)]
		let mut list = Vec::with_capacity(152);
		#[cfg(feature = "root-actionscript")]
