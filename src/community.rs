...
pub enum Community {
	...
	Beef,
	#[cfg(feature = "community-box-lang-cold-box")]
	BoxLangColdBox,
	#[cfg(feature = "community-cfml-cold-box")]
	CfmlColdBox,
	...
	JavaScriptCordova,
	#[cfg(feature = "community-java-script-expo")]
	JavaScriptExpo,
	...
	Logtalk,
	#[cfg(feature = "community-meta-trader5")]
	MetaTrader5,
...
impl GitIgnore for Community {
	...
	fn file_name(self) -> &'static str {
		match self {
			...
			#[cfg(feature = "community-box-lang-cold-box")]
			Self::BoxLangColdBox => "ColdBox.gitignore",
			#[cfg(feature = "community-cfml-cold-box")]
			Self::CfmlColdBox => "ColdBox.gitignore",
			#[cfg(feature = "community-dot-net-core")]
			...
			#[cfg(feature = "community-java-script-expo")]
			Self::JavaScriptExpo => "Expo.gitignore",
			#[cfg(feature = "community-java-script-meteor")]
			...
			#[cfg(feature = "community-libogc")]
			Self::Libogc => "libogc.gitignore",
			#[cfg(feature = "community-linux-snap")]
			Self::LinuxSnap => "Snap.gitignore",
			#[cfg(feature = "community-logtalk")]
			Self::Logtalk => "Logtalk.gitignore",
			#[cfg(feature = "community-meta-trader5")]
			Self::MetaTrader5 => "MetaTrader5.gitignore",
			#[cfg(feature = "community-move")]
	...
	fn file_path(self) -> &'static str {
		match self {
			...
			#[cfg(feature = "community-box-lang-cold-box")]
			Self::BoxLangColdBox => "community/BoxLang/ColdBox.gitignore",
			#[cfg(feature = "community-cfml-cold-box")]
			Self::CfmlColdBox => "community/CFML/ColdBox.gitignore",
			#[cfg(feature = "community-dot-net-core")]
			...
			#[cfg(feature = "community-dotter")]
			Self::Dotter => "community/Dotter.gitignore",
			#[cfg(feature = "community-elixir-phoenix")]
			...
			#[cfg(feature = "community-java-script-expo")]
			Self::JavaScriptExpo => "community/JavaScript/Expo.gitignore",
			#[cfg(feature = "community-java-script-meteor")]
			...
			#[cfg(feature = "community-libogc")]
			Self::Libogc => "community/libogc.gitignore",
			#[cfg(feature = "community-linux-snap")]
			Self::LinuxSnap => "community/Linux/Snap.gitignore",
			#[cfg(feature = "community-logtalk")]
			Self::Logtalk => "community/Logtalk.gitignore",
			#[cfg(feature = "community-meta-trader5")]
			Self::MetaTrader5 => "community/MetaTrader5.gitignore",
			#[cfg(feature = "community-move")]
			...
			#[cfg(feature = "community-utau")]
			Self::Utau => "community/UTAU.gitignore",
			#[cfg(feature = "community-v")]
	...
	fn list() -> Vec<&'static str> {
		#[allow(unused_mut)]
		let mut list = Vec::with_capacity(69);
		#[cfg(feature = "community-alteryx")]
		list.push("Alteryx");
		#[cfg(feature = "community-altium-designer")]
		...
		list.push("Beef");
		#[cfg(feature = "community-box-lang-cold-box")]
		list.push("BoxLangColdBox");
		#[cfg(feature = "community-cfml-cold-box")]
		list.push("CfmlColdBox");
		#[cfg(feature = "community-dot-net-core")]
	...
	fn get(variant: &'static str) -> Option<Self> {
		...
		Some(match variant {
			...
			"Beef" => Self::Beef,
			#[cfg(feature = "community-box-lang-cold-box")]
			"BoxLangColdBox" => Self::BoxLangColdBox,
			#[cfg(feature = "community-cfml-cold-box")]
			"CfmlColdBox" => Self::CfmlColdBox,
			#[cfg(feature = "community-dot-net-core")]
			...
			#[cfg(feature = "community-java-script-expo")]
			"JavaScriptExpo" => Self::JavaScriptExpo,
			#[cfg(feature = "community-java-script-meteor")]
